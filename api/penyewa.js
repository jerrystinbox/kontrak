...
const CONFIG = {   
    gg55:    { BusinessID: "GG",    pageTitle: "Property Kantor Hijau 🔒︎", db: process.env.NOTION_DB_PENYEWA_KANTOR, pinAdmin: process.env.PIN_ADMIN, pinInsert: process.env.PIN_ADMIN },
    gg22:    { BusinessID: "GG",    pageTitle: "Property Kantor Hijau 🔍︎", db: process.env.NOTION_DB_PENYEWA_KANTOR, pinAdmin: "2095231",             pinInsert: "2095231" },
    gg42:    { BusinessID: "GG",    pageTitle: "Property Kantor Hijau",    db: process.env.NOTION_DB_PENYEWA_KANTOR, pinAdmin: "251011",              pinInsert: "251011" }
};
